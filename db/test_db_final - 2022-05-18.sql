...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2022 at 05:32 AM
...
(47, 5, 'AMD Ryzen 5 5600X - Ryzen 5 5000 Series Vermeer (Zen 3) 6-Core 3.7 GHz Socket AM4 65W Desktop Processor - 100-100000065BOX', '7nm Vermeer (Zen 3) 65W32MB L3 Cache', 13900, 50, 'AMD-1-removebg-preview.png', '2022-05-17 03:55:17'),
(48, 24, 'CHAFON RGB Gaming Headset with Mic for Xbox One, PS4, PS5, Over-Ear Headphones with Stereo Surround Sound, Dynamic RGB Light, Memory Foam Earcups, Noise Canceling Mic for PC, Laptop, Phone', 'Surround Sound Headset: This headphones is a professional gaming headset equipped with superior 50mm audio drivers combined with advanced audio techniques. It delivers quality simulated surround sound to enhance the immersive gaming experience.\r\nNoise Cancelling Mic: PC headset with Noise Cancelling Microphone ?provides high-end noise cancellation can pick up sounds with great sensitivity and remove the noise, which enable you to chat to your fellow players with crystal clarity.\r\n[Multi-Platform Compatibility]: This xbox one headset support most modern devices which has a 3.5mm jack like PS4, PS vita, Tablet, PSP, Laptop, Xbox One, Xbox 360, Switch (audio), 3DS LL/3DS (audio), Mac OS, iOS and Android device.\r\n[Ergonomically Design & Premium Material]: The PS4 headset equipped with super soft protein over-ear pads and head beam.The adjustable headband according to the ergonomic design ensure every player could enjoy the optimal wearing comfort, allow for long gaming sessions without fatigue.\r\nCool RGB Lighting Effects: PS4 headset with dynamic RGB lighting design on the side which create a realistic gaming atmosphere. Please note the USB plug is only for RGB light, no audio transmission function.', 5300, 50, 'product-628470a300341_2022-05-18.png', '2022-05-18 04:05:55');
...
(10, 4, 'QGXDHAPVMS_dgpxmshqva-31f98bbeb62.22654515', 12658, '2022-05-17 04:07:52'),
(11, 4, 'NOTKGFEIDC_igoktcfden-31fde850e91.10337782', 12658, '2022-05-17 04:09:02'),
(12, 4, 'DTIAMGRXFK_rigadmfkxt-3215296da59.42421440', 4502, '2022-05-17 04:15:14');
...
(6, 'Killua', 'Zoldyck', 'Male', 'Davao', 21, '2022-05-02', 1123123, 'killua@gmail.com', 'kill', '1234', 0, 'userplaceholder.png', '2022-05-17 04:47:44');

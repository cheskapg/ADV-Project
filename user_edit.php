...
$sql = "UPDATE users SET fname ='$edit_fname',lname='$edit_lname',gender='$edit_gender',age='$edit_age',birth='$edit_birth',contno='$edit_contno',email='$edit_email' WHERE id=$user_id;";
